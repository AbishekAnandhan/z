  ...
  <div>
    ...
    <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          <h3 class="text-warning pt-3 title">Mission</h3>
          <hr />
          <!-- <img
            src="images/mission.jpg"
            class="img-fluid d-block rounded mx-auto image-thumbnail"> -->
          <p class="mt-2">Our mission is to revolutionize the technological landscape by providing innovative IoT and web application 
            solutions that enhance connectivity, efficiency, and user experience. We strive to deliver high-quality, reliable, and 
            scalable products that empower businesses and individuals to achieve their full potential in a connected world.</p>
        </div>
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          <h3 class="text-warning pt-3 title">Mission</h3>
        ...
        <div class="col-md-5 mt-3">
          ...
          <h3 class="text-warning pt-3 title">Vision</h3>
          ...
          <!-- <img
            ...
            class="img-fluid d-block rounded mx-auto image-thumbnail"> -->
          <p>Our vision is to be a global leader in IoT and web application development, driving technological advancements and 
            fostering a more connected and intelligent world. We aim to inspire and lead the digital transformation journey for 
            businesses and consumers, ensuring a future where technology seamlessly integrates with and enhances everyday life
          </p>
